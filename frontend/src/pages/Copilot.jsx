  ...
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content:
        "Hi! I'm VyaparSaathi, your friendly compliance assistant. Ask me anything about compliance, taxes, or what you need to do. I'm here to help! 😊",
    },
  ]);
      ...
      <div className="flex-1 flex flex-col max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">
            Ask me anything about compliance. I'm here to help, not judge! 😊
          </p>
        </div>
